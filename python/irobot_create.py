...
class Roomba(object):
    ...
    def set_drive_backwards(self,velocity_mms):
        self.set_drive_direct(-velocity_mms,-velocity_mms)
    ...
    def set_cleaning_all(self):
        cmd = b'\x8A\x07'
        self.roomba.write(cmd)

    def set_cleaning_off(self):
        cmd = b'\x8A\x00'
        self.roomba.write(cmd)
